...
local rd16, wr16, wr32, get_ihl = lwutil.rd16, lwutil.wr16, lwutil.wr32, lwutil.get_ihl
local cast = ffi.cast
local C = ffi.C
...
function reassemble_ipv4(fragments)
