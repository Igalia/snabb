...
function lwaftr_app(c, conf, lwconf, sock_path)
   ...
   if conf.ipv4_interface and conf.ipv6_interface then
      ...
      config.link(c, "nh_fwd6.service -> remove_ipv6.input")
      config.link(c, "remove_ipv6.output -> lwaftr.v6")
      config.link(c, "lwaftr.v6 -> insert_ipv6.input")
      config.link(c, "insert_ipv6.output -> nh_fwd6.service")
      config.link(c, "nh_fwd4.service -> remove_ipv4.input")
      config.link(c, "remove_ipv4.output -> lwaftr.v4")
      config.link(c, "lwaftr.v4 -> insert_ipv4.input")
      config.link(c, "insert_ipv4.output -> nh_fwd4.service")
