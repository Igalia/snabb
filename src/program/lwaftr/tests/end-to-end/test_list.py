tests = (
    ("Regression test: make sure ntohl'd high-bit-set fragment IDs do not crash",
     "no_icmp.conf",  "",  "regressiontest-signedntohl-frags.pcap",  "",
    ...
    ("Regression test: make sure end-addr works",
     "icmp_endaddr.conf", "regressiontest-endaddr-v4-input.pcap", "", "",
     "regressiontest-endaddr-v5-output.pcap", "regressiontest-endaddr.lua"),

    ("from-internet IPv4 packet found in the binding table.",
     "icmp_on_fail.conf", "tcp-frominet-bound.pcap", "", "",
     "tcp-afteraftr-ipv6.pcap", "in-1p-ipv4-out-1p-ipv6-1.lua"),

    ("from-internet IPv4 packet found in the binding table with vlan tag.",
     "vlan.conf", "tcp-frominet-bound-vlan.pcap", "", "",
     "tcp-afteraftr-ipv6-vlan.pcap", "in-1p-ipv4-out-1p-ipv6-1.lua"),

    ("NDP: incoming NDP Neighbor Solicitation",
     "tunnel_icmp.conf", "", "ndp_incoming_ns.pcap", "",
     "ndp_outgoing_solicited_na.pcap", "nofrag6-sol.lua"),
    ...
    # mergecap -F pcap -w ndp_ns_and_recap.pcap recap-ipv6.pcap
    # ndp_outgoing_ns.pcap
    ("NDP: Without receiving NA, next_hop6_mac not set",
     "tunnel_icmp_withoutmac.conf", "", "ndp_without_dst_eth_compound.pcap",
     "decap-ipv4.pcap", "ndp_outgoing_ns.pcap",
    ...
    # mergecap -F pcap -w ndp_ns_and_recap.pcap ndp_outgoing_ns.pcap
    # recap-ipv6.pcap
    ("NDP: With receiving NA, next_hop6_mac not initially set",
     "tunnel_icmp_withoutmac.conf", "", "ndp_getna_compound.pcap",
     "decap-ipv4.pcap", "ndp_ns_and_recap.pcap",
    ...
    ("from-internet IPv4 fragmented packets found in the binding table.",
     "icmp_on_fail.conf", "tcp-ipv4-3frags-bound.pcap", "", "",
     "tcp-afteraftr-ipv6-reassembled.pcap", "in-1p-ipv4-out-1p-ipv6-2.lua"),

    ("from-internet IPv4 fragmented packets found in the binding table, reversed.",
     "icmp_on_fail.conf", "tcp-ipv4-3frags-bound-reversed.pcap", "", "",
     "tcp-afteraftr-ipv6-reassembled.pcap", "in-1p-ipv4-out-1p-ipv6-2.lua"),

    ("traffic class mapping",
     "icmp_on_fail.conf", "tcp-frominet-trafficclass.pcap", "", "",
     "tcp-afteraftr-ipv6-trafficclass.pcap", "in-1p-ipv4-out-1p-ipv6-1.lua"),

    ("from-internet IPv4 packet found in the binding table, original TTL=1.",
     "icmp_on_fail.conf", "tcp-frominet-bound-ttl1.pcap", "",
     "icmpv4-time-expired.pcap", "", "tcp-frominet-bound-ttl1.lua"),

    ("from-B4 IPv4 fragmentation (2),",
     "small_ipv4_mtu_icmp.conf", "", "tcp-ipv6-fromb4-toinet-1046.pcap",
     "tcp-ipv4-toinet-2fragments.pcap", "", "in-1p-ipv6-out-1p-ipv4-1.lua"),

    ("from-B4 IPv4 fragmentation (3),",
     "small_ipv4_mtu_icmp.conf", "", "tcp-ipv6-fromb4-toinet-1500.pcap",
     "tcp-ipv4-toinet-3fragments.pcap", "", "in-1p-ipv6-out-1p-ipv4-2.lua"),

    ("from-internet IPv4 packet found in the binding table, needs IPv6 fragmentation (2),.",
     "small_ipv6_mtu_no_icmp.conf", "tcp-frominet-bound1494.pcap", "", "",
     "tcp-afteraftr-ipv6-2frags.pcap", "in-1p-ipv4-out-1p-ipv6-3.lua"),

    ("from-internet IPv4 packet found in the binding table, needs IPv6 fragmentation (3),.",
     "small_ipv6_mtu_no_icmp.conf", "tcp-frominet-bound-2734.pcap", "", "",
     "tcp-afteraftr-ipv6-3frags.pcap", "in-1p-ipv4-out-1p-ipv6-4.lua"),

    ("IPv6 reassembly (to one packet),.",
     "big_mtu_no_icmp.conf", "", "tcp-ipv6-2frags-bound.pcap",
     "tcp-ipv4-2ipv6frags-reassembled-1p.pcap", "",
     "in-1p-ipv6-out-1p-ipv4-3.lua"),

    ("IPv6 reassembly (out of order fragments),.",
     "big_mtu_no_icmp.conf", "", "tcp-ipv6-2frags-bound-reverse.pcap",
     "tcp-ipv4-2ipv6frags-reassembled-1p.pcap", "",
     "in-1p-ipv6-out-1p-ipv4-3.lua"),
    ...
    ("IPv6 reassembly (followed by decapsulation),.",
     "small_ipv6_mtu_no_icmp.conf", "", "tcp-ipv6-2frags-bound.pcap",
    ...
    ("from-internet IPv4 packet found in the binding table, needs IPv6 fragmentation, DF set, ICMP-3,4, allow policy.",
     "small_ipv6_mtu_no_icmp_allow.conf", "tcp-frominet-bound1494-DF.pcap", "",
    ...
    ("from-internet IPv4 packet NOT found in the binding table (ICMP-on-fail),.",
     "icmp_on_fail.conf", "tcp-frominet-unbound.pcap", "",
     "icmpv4-dst-host-unreachable.pcap", "", "in-1p-ipv4-out-1p-icmpv4.lua"),

    ("from-internet IPv4 packet NOT found in the binding table (IPv4 matches, but port doesn't), (ICMP-on-fail).",
     "icmp_on_fail.conf", "tcp-frominet-ip-bound-port-unbound.pcap", "",
    ...
    ("from-b4 to-internet IPv6 packet NOT found in the binding table (ICMP-on-fail),",
     "icmp_on_fail.conf", "", "tcp-fromb4-ipv6-unbound.pcap", "",
     "icmpv6-nogress.pcap", "in-1p-ipv6-out-1p-icmpv6-1.lua"),

    ("from-b4 to-internet IPv6 packet NOT found in the binding table (IPv4 matches, but port doesn't), (ICMP-on-fail)",
     "icmp_on_fail.conf", "", "tcp-fromb4-ipv6-bound-port-unbound.pcap", "",
    ...
    ("from-to-b4 IPv6 packet, no hairpinning",
     "no_hairpin.conf", "", "tcp-fromb4-tob4-ipv6.pcap",
     "decap-ipv4-nohair.pcap", "", "in-1p-ipv6-out-1p-ipv4-4.lua"),
    ...
    ("from-to-b4 IPv6 packet, with hairpinning, number of packets 64",
     "no_icmp.conf", "", "tcp-fromb4-tob4-ipv6-n64.pcap", "",
     "recap-ipv6-n64.pcap", "from-to-b4-ipv6-hairpin-n64.lua"),
    ...
    ("from-to-b4 tunneled ICMPv4 ping, with hairpinning",
     "tunnel_icmp.conf", "", "hairpinned-icmpv4-echo-request.pcap", "",
    ...
    ("from-to-b4 tunneled ICMPv4 ping reply, with hairpinning",
     "tunnel_icmp.conf", "", "hairpinned-icmpv4-echo-reply.pcap", "",
    ...
    ("from-to-b4 tunneled ICMPv4 ping reply, with hairpinning, port 0 not bound",
     "tunnel_icmp.conf", "", "hairpinned-icmpv4-echo-reply-unbound.pcap", "",
     "hairpinned-icmpv4-echo-reply-unbound-from-aftr.pcap",
     "in-1p-ipv6-out-1p-icmpv6-2.lua"),

    ("from-to-b4 TCP packet, with hairpinning, TTL 1",
     "tunnel_icmp.conf", "", "tcp-fromb4-tob4-ipv6-ttl-1.pcap", "",
    ...
    ("from-to-b4 IPv6 packet, with hairpinning, with vlan tag",
     "vlan.conf", "", "tcp-fromb4-tob4-ipv6-vlan.pcap", "",
     "recap-ipv6-vlan.pcap", "from-to-b4-ipv6-hairpin.lua"),

    ("from-b4 IPv6 packet, with hairpinning, to B4 with custom lwAFTR address",
     "no_icmp.conf", "", "tcp-fromb4-tob4-customBRIP-ipv6.pcap", "",
     "recap-tocustom-BRIP-ipv6.pcap", "from-to-b4-ipv6-hairpin.lua"),

    ("from-b4 IPv6 packet, with hairpinning, from B4 with custom lwAFTR address",
     "no_icmp.conf", "", "tcp-fromb4-customBRIP-tob4-ipv6.pcap", "",
     "recap-fromcustom-BRIP-ipv6.pcap", "from-to-b4-ipv6-hairpin.lua"),

    ("from-b4 IPv6 packet, with hairpinning, different non-default lwAFTR addresses",
     "no_icmp.conf", "", "tcp-fromb4-customBRIP1-tob4-customBRIP2-ipv6.pcap",
     "", "recap-customBR-IPs-ipv6.pcap", "from-to-b4-ipv6-hairpin.lua"),
    ...
    ("from-internet bound IPv4 UDP packet",
     "icmp_on_fail.conf", "udp-frominet-bound.pcap", "", "",
     "udp-afteraftr-ipv6.pcap", "in-1p-ipv4-out-1p-ipv6-6.lua"),

    ("unfragmented IPv4 UDP -> outgoing IPv6 UDP fragments",
     "small_ipv6_mtu_no_icmp.conf", "udp-frominet-bound.pcap", "", "",
     "udp-afteraftr-ipv6-2frags.pcap", "in-1p-ipv4-out-1p-ipv6-6-outfrags.lua"),

    ("IPv6 incoming UDP fragments -> unfragmented IPv4",
     "icmp_on_fail.conf", "", "udp-fromb4-2frags-bound.pcap",
    ...
    ("IPv6 incoming UDP fragments -> outgoing IPv4 UDP fragments",
     "small_ipv4_mtu_icmp.conf", "", "udp-fromb4-2frags-bound.pcap",
     "udp-afteraftr-ipv4-3frags.pcap", "", "in-1p-ipv6-out-1p-ipv4-5.lua"),

    ("IPv4 incoming UDP fragments -> outgoing IPv6 UDP fragments",
     "small_ipv6_mtu_no_icmp.conf", "udp-frominet-3frag-bound.pcap", "", "",
    ...
    ("incoming ICMPv4 echo request, matches binding table",
     "tunnel_icmp.conf", "incoming-icmpv4-echo-request.pcap", "", "",
    ...
    ("incoming ICMPv6 1,3 destination/address unreachable, OPE from internet",
     ...
     "response-ipv4-icmp31-inet.pcap", "", "in-1p-ipv6-out-1p-icmpv4-1.lua"),

    ("incoming ICMPv6 2,0 'too big' notification, OPE from internet",
     "tunnel_icmp.conf", "", "incoming-icmpv6-20pkttoobig-inet-OPE.pcap",
     "response-ipv4-icmp34-inet.pcap", "",
     "in-1p-ipv6-out-1p-icmpv4-1.lua"),

    ("incoming ICMPv6 3,0 hop limit exceeded, OPE from internet",
     "tunnel_icmp.conf", "", "incoming-icmpv6-30hoplevelexceeded-inet-OPE.pcap",
     "response-ipv4-icmp31-inet.pcap", "", "in-1p-ipv6-out-1p-icmpv4-1.lua"),
    ...
    ("incoming ICMPv6 4,3 parameter problem, OPE from internet",
     "tunnel_icmp.conf", "", "incoming-icmpv6-43paramprob-inet-OPE.pcap",
     "response-ipv4-icmp31-inet.pcap", "", "in-1p-ipv6-out-1p-icmpv4-1.lua"),
    ...
    ("ingress-filter: from-internet (IPv4), packet found in binding table (ACCEPT)",
     "no_icmp_with_filters_accept.conf", "tcp-frominet-trafficclass.pcap", "",
    ...
    ("ingress-filter: from-b4 (IPv6), packet found in binding table (ACCEPT)",
     "no_icmp_with_filters_accept.conf", "", "tcp-fromb4-ipv6.pcap",
     "decap-ipv4.pcap", "", "in-1p-ipv6-out-1p-ipv4-4.lua"),
    ...
    ("ICMP Echo to AFTR (IPv4), + data",
     "no_icmp.conf", "ping-v4-and-data.pcap", "", "ping-v4-reply.pcap",
     "tcp-afteraftr-ipv6.pcap", "in-1p-ipv4-out-1p-ipv6-echo.lua"),
    ...
    ("ICMP Echo to AFTR (IPv6), + data",
     "no_icmp.conf", "", "ping-v6-and-data.pcap", "decap-ipv4.pcap",
     "ping-v6-reply.pcap", "in-1p-ipv6-out-1p-ipv4-4-and-echo.lua")
)
